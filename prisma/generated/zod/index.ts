...
export const UserScalarFieldEnumSchema = z.enum(['id','kakao_id','name','nickname','phone_number','location','gender','role','hunt_count','age_group','email','password','created_at','updated_at','terms_accepted','fcm_token','pr_memo']);
